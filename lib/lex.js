...
function lexRequestHandler(event, context, callback) {
  event.sessionAttributes = event.sessionAttributes || {};
  event.currentIntent = event.currentIntent || {};
  event.currentIntent.slots = event.currentIntent.slots || {};
  ...
  for(var arg = 0; arg < arguments.length; arg++) {
    ...
    for(var i = 0; i < eventNames.length; i++) {
      ...
      var handlerContext = {
        ...
        slots: this._event.currentIntent.slots,
        context: this._context,
        name: this._event.currentIntent.name,
